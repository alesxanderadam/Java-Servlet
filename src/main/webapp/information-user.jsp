        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Mentor login xong reload trang giúp em nha, chỗ này e không biết dùng reload page thế nào</h4>
                </div>
                <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 text-right">
                    <form method="post" action="<%=contextPath%>/information-user">
            ...
            <div class="row">
                <div class="col-12 col-xs-12">
                    <div class="white-box">
                        <div class="user-bg" style="height: 100%"> <img width="100%" alt="user" src="plugins/images/large/img1.jpg">
                            <div class="overlay-box">
                                <div class="user-content">
                                    <a href="javascript:void(0)"><img src="${avatar}" class="thumb-lg img-circle" alt="img"></a>
